...
class AppConfig @Inject() (config: Configuration, servicesConfig: ServicesConfig) {
  ...
  val cardPaymentFrontendBaseUrl: String = config.get[String]("urls.card-payment-frontend.base-url") //don't need the relative bit, i.e. /pay-by-card as reverse routes add it for us.
