...
final case class PaymentAttemptAuditDetail(
  address:              Address,
  ...
  override val auditType: String = "PaymentAttempt"
}

object PaymentAttemptAuditDetail {
  implicit val writes: OWrites[PaymentAttemptAuditDetail] = Json.writes[PaymentAttemptAuditDetail]
}
