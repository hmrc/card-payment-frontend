...
import payapi.cardpaymentjourney.model.journey.{JourneySpecificData, JsdPfJobRetentionScheme}
...
import uk.gov.hmrc.cardpaymentfrontend.models.openbanking.{OriginSpecificSessionData, PfJobRetentionSchemeSessionData}

object ExtendedPfJobRetentionScheme extends ExtendedOrigin {

  override def serviceNameMessageKey: String = "service-name.PfJobRetentionScheme"

  override def taxNameMessageKey: String = "payment-complete.tax-name.PfJobRetentionScheme"

  override def cardFeesPagePaymentMethods: Set[PaymentMethod] = Set(OneOffDirectDebit, Bacs)
