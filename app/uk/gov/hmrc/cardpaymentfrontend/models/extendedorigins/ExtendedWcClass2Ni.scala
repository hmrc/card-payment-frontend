...
object ExtendedWcClass2Ni extends ExtendedOrigin {
  override val serviceNameMessageKey: String = "service-name.WcClass2Ni"
  override val taxNameMessageKey: String = "payment-complete.tax-name.WcClass2Ni"
  ...
  override def checkYourAnswersReferenceRow(journeyRequest: JourneyRequest[AnyContent])(payFrontendBaseUrl: String): Option[CheckYourAnswersRow] = {
    Some(CheckYourAnswersRow(
      titleMessageKey = "check-your-details.WcClass2Ni.reference",
  ...
  override def openBankingOriginSpecificSessionData: JourneySpecificData => Option[OriginSpecificSessionData] = {
    case j: JsdWcClass2Ni => Some(WcClass2NiSessionData(j.class2NiReference))
    case _                => throw new RuntimeException("Incorrect origin found")
  }

  override def emailTaxTypeMessageKey: String = "email.tax-name.WcClass2Ni"

  override def surveyAuditName: String = "class-2-national-insurance"
