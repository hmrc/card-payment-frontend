...
object ExtendedBtaSdil extends ExtendedOrigin {
  override val serviceNameMessageKey: String = "service-name.BtaSdil"
  override val taxNameMessageKey: String     = "payment-complete.tax-name.BtaSdil"
  ...
  override def checkYourAnswersReferenceRow(journeyRequest: JourneyRequest[AnyContent])(payFrontendBaseUrl: String): Option[CheckYourAnswersRow] = {
    Some(
      CheckYourAnswersRow(
        titleMessageKey = "check-your-details.BtaSdil.reference",
  ...
  override def emailTaxTypeMessageKey: String = "email.tax-name.BtaSdil"
}
