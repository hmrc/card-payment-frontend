...
import uk.gov.hmrc.cardpaymentfrontend.models.extendedorigins.ExtendedBtaVapingProductsDuty.changeReferenceUrl
...
object ExtendedBtaVapingProductsDuty extends ExtendedOrigin {
  ...
  override def checkYourAnswersReferenceRow(journeyRequest: JourneyRequest[AnyContent])(payFrontendBaseUrl: String): Option[CheckYourAnswersRow] = {
    Some(
      CheckYourAnswersRow(
        titleMessageKey = "check-your-details.BtaVapingProductsDuty.reference",
