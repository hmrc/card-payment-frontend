...
object ExtendedBtaVapingProductsDuty extends ExtendedOrigin {
  ...
  override def openBankingOriginSpecificSessionData: JourneySpecificData => Option[OriginSpecificSessionData] = {
    case j: JsdBtaVapingProductsDuty =>
      Some(BtaVapingProductsDutySessionData(j.vapingDutyReference, j.chargeReferenceNumber, j.defaultAmountInPence, None))
    case _                           => throw new RuntimeException("Incorrect origin found")
  }

  private def additionalReference: JourneySpecificData => Option[VapingDutyChargeReference] = {
    case j: JsdBtaVapingProductsDuty => j.chargeReferenceNumber
    case _                           => throw new RuntimeException("Incorrect origin found")
  }
