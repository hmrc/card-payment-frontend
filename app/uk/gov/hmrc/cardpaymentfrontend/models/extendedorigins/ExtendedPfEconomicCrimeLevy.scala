...
import payapi.cardpaymentjourney.model.journey.{JourneySpecificData, JsdPfEconomicCrimeLevy}
import play.api.mvc.{AnyContent, Call}
import uk.gov.hmrc.cardpaymentfrontend.actions.JourneyRequest
import uk.gov.hmrc.cardpaymentfrontend.models.PaymentMethod.{Bacs, Card, OneOffDirectDebit, OpenBanking}
import uk.gov.hmrc.cardpaymentfrontend.models.openbanking.{OriginSpecificSessionData, PfEconomicCrimeLevySessionData}
import uk.gov.hmrc.cardpaymentfrontend.models.{CheckYourAnswersRow, Link, PaymentMethod}

object ExtendedPfEconomicCrimeLevy extends ExtendedOrigin {
  override val serviceNameMessageKey: String = "service-name.PfEconomicCrimeLevy"
  override val taxNameMessageKey: String     = "payment-complete.tax-name.PfEconomicCrimeLevy"
  ...
  override def checkYourAnswersReferenceRow(journeyRequest: JourneyRequest[AnyContent])(payFrontendBaseUrl: String): Option[CheckYourAnswersRow] = {
    Some(
      CheckYourAnswersRow(
        titleMessageKey = "check-your-details.PfEconomicCrimeLevy.reference",
