...
import payapi.cardpaymentjourney.model.journey.{JourneySpecificData, JsdPfTrust}
...
import uk.gov.hmrc.cardpaymentfrontend.models.openbanking.{OriginSpecificSessionData, PfTrustSessionData}

object ExtendedPfTrust extends ExtendedOrigin {
  override val serviceNameMessageKey: String = "service-name.PfTrust"
  override val taxNameMessageKey: String     = "payment-complete.tax-name.PfTrust"
  ...
  override def checkYourAnswersReferenceRow(journeyRequest: JourneyRequest[AnyContent])(payFrontendBaseUrl: String): Option[CheckYourAnswersRow] = {
    Some(
      CheckYourAnswersRow(
        titleMessageKey = "check-your-details.PfTrust.reference",
  ...
  override def openBankingOriginSpecificSessionData: JourneySpecificData => Option[OriginSpecificSessionData] = {
    case j: JsdPfTrust => j.trustsReference.map(prn => PfTrustSessionData(prn))
