...
object ExtendedJrsJobRetentionScheme extends ExtendedOrigin {
  override val serviceNameMessageKey: String = "service-name.JrsJobRetentionScheme"
  override val taxNameMessageKey: String = "payment-complete.tax-name.JrsJobRetentionScheme"
