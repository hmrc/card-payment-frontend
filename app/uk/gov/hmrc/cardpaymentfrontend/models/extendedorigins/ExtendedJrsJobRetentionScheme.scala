...
import payapi.cardpaymentjourney.model.journey.{JourneySpecificData, JsdJrsJobRetentionScheme}
...
object ExtendedJrsJobRetentionScheme extends ExtendedOrigin {
  ...
  override def serviceNameMessageKey: String = "service-name.JrsJobRetentionScheme"

  override def taxNameMessageKey: String = "payment-complete.tax-name.JrsJobRetentionScheme"
  ...
  override def emailTaxTypeMessageKey: String = "email.tax-name.JrsJobRetentionScheme"
