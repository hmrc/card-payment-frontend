...
import payapi.cardpaymentjourney.model.journey.{JourneySpecificData, JsdWcEpayeSeta}
import play.api.mvc.AnyContent
import uk.gov.hmrc.cardpaymentfrontend.actions.JourneyRequest
import uk.gov.hmrc.cardpaymentfrontend.models.PaymentMethod.{Bacs, Card, OpenBanking}
import uk.gov.hmrc.cardpaymentfrontend.models.openbanking.{OriginSpecificSessionData, WcEpayeSetaSessionData}
import uk.gov.hmrc.cardpaymentfrontend.models.{CheckYourAnswersRow, PaymentMethod}

object ExtendedWcEpayeSeta extends ExtendedOrigin {

  override def serviceNameMessageKey: String = "service-name.WcEpayeSeta"

  override def taxNameMessageKey: String = "payment-complete.tax-name.WcEpayeSeta"
