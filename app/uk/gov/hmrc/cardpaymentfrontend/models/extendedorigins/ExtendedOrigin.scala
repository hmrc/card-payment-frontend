...
object ExtendedOrigin {
  implicit class OriginExtended(origin: Origin) {
    ...
    def isAWebChatOrigin: Boolean = origin match {
      ...
      case Origins.WcSa | Origins.WcCt | Origins.WcVat | Origins.WcSimpleAssessment | Origins.WcXref | Origins.WcEpayeLpp | Origins.WcClass1aNi | Origins.WcEpayeNi | Origins.WcEpayeSeta => true
    }
  }
}
