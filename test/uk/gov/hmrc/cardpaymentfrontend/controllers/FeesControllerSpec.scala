...
import payapi.corcommon.model.Origins.{PfVapingProductsDuty, VpdVapingProductsDuty}
        ...
        .foreach { origin =>
          s"should return the correct links for each origin: ${origin.entryName}" in {
            ...
            val expectedLinks: Seq[Link] = origin match {
              ...
              case Origins.WcSdlt                                                               => Seq(expectedOpenBankingLink)
              ...
              case Origins.BtaVapingProductsDuty | VpdVapingProductsDuty | PfVapingProductsDuty => Seq(expectedOpenBankingLink, expectedVariableDirectDebitLink)
            }
