  ...
  "PaymentCompleteController" - {
    ...
    "GET /payment-complete" - {
      ...
      "render the survey content correctly" in {
        ...
        surveyWrapper
          .select("#survey-link-wrapper")
          .html() shouldBe """<a class="govuk-link" href="/pay-by-card/start-payment-survey">Tell us what you think of this service</a> (takes 30 seconds)"""
      }
      ...
      "render the survey content correctly in welsh" in {
        ...
        surveyWrapper
          .select("#survey-link-wrapper")
          .html() shouldBe """<a class="govuk-link" href="/pay-by-card/start-payment-survey">Rhowch wybod i ni beth yw eich barn am y gwasanaeth hwn</a> (mae’n cymryd 30 eiliad)"""
      }
      ...
      "should render the webchat specific content for webchat origins" in {
        ...
        val document = Jsoup.parse(contentAsString(result))
        document
          .select("#web-chat-content")
          .text() shouldBe "If you need further help with a tax bill, return to the webchat and speak with the webchat handler."
      }
      ...
      "should render the webchat specific content in welsh for webchat origins" in {
        ...
        document
          .select("#web-chat-content")
          .text() shouldBe "Os oes angen cymorth pellach arnoch gyda’ch bil treth, bydd angen dychwelyd i’r sgwrs dros y we a siarad ag ymgynghorydd."
      }
      ...
      "render custom what happens next content for PfMgd" in {
        ...
        wrapper
          ...
          .asList()
          .get(1)
          .text() shouldBe "You can set up a variable Direct Debit to make all your future Machine Games Duty payments automatically. Having a Direct Debit means you will not miss deadlines or get late payment charges."
        wrapper.select("a").attr("href").contains("/gg/sign-in?continue=/business-account/&origin=MGD-frontend") shouldBe true
        wrapper
          .select("p")
          .asList()
          .get(2)
          .text() shouldBe "Set up your Direct Debit at least 5 days before your next payment is due to make sure you meet the payment deadline."
      }
      ...
      "render custom what happens next content for PfMgd in welsh" in {
        ...
        wrapper
          ...
          .asList()
          .get(1)
          .text() shouldBe "Gallwch sefydlu Debyd Uniongyrchol newidiol i wneud eich holl daliadau Toll Peiriannau Hapchwarae yn awtomatig yn y dyfodol. Mae cael Debyd Uniongyrchol yn golygu na fyddwch yn methu dyddiadau cau nac yn wynebu costau am dalu’n hwyr."
        wrapper
          .select("p")
          .asList()
          .get(2)
          .text() shouldBe "Sefydlwch eich Debyd Uniongyrchol o leiaf 5 diwrnod cyn dyddiad dyledus eich taliad nesaf er mwyn gwneud yn siŵr eich bod yn talu erbyn y dyddiad cau."
      }
      ...
      "should render the extra row for p800ChargeReference when it's in the journey" - {
        "for PfP800" in {
          val testJourney: Journey[JsdPfP800] =
            TestDataUtils.intoSuccessWithOrder(TestJourneys.PfP800.journeyWithP800ChargeRefBeforeBeginWebPayment, TestDataUtils.debitCardOrder)
        ...
        "for PtaP800" in {
          val testJourney: Journey[JsdPtaP800] =
            TestDataUtils.intoSuccessWithOrder(TestJourneys.PtaP800.journeyWithP800ChargeRefBeforeBeginWebPayment, TestDataUtils.debitCardOrder)
          PayApiStub.stubForFindBySessionId2xx(testJourney)
          val result                           = systemUnderTest.renderPage(fakeGetRequest)
          val document                         = Jsoup.parse(contentAsString(result))
          val panel                            = document.body().select(".govuk-panel--confirmation")
      ...
      "should render the custom payment complete page for Mib" in {
        ...
        bringGoodsContent
          .select("p")
          .text() shouldBe "If you bring EU-produced goods that have a total value over £1,000, you need to carry proof they were made in the EU."
        val links                        = modsSpecificContent.select("#mods-links").select("p").asScala.toList
        links(0)
          .html() shouldBe "<a class=\"govuk-link\" href=\"http://localhost:8281/declare-commercial-goods/make-another-declaration\">Make a new declaration</a>"
        ...
        document
          .select("#survey-wrapper")
          .select("#survey-link-wrapper")
          .html() shouldBe "<a class=\"govuk-link\" href=\"http://localhost:8281/declare-commercial-goods/survey\">Tell us what you think of this service</a> (takes 30 seconds)"
      }
      ...
      "should render the custom payment complete page in welsh for Mib" in {
        ...
        bringGoodsContent
          .select("p")
          .text() shouldBe "Os ydych yn dod â nwyddau a gynhyrchwyd yn yr UE gyda chi y mae cyfanswm eu gwerth dros £1,000, mae’n rhaid i chi gario tystiolaeth y cawsant eu gwneud yn yr UE."
        val links                        = modsSpecificContent.select("#mods-links").select("p").asScala.toList
        ...
        document
          .select("#survey-wrapper")
          .select("#survey-link-wrapper")
          .html() shouldBe "<a class=\"govuk-link\" href=\"http://localhost:8281/declare-commercial-goods/survey\">Rhowch wybod i ni beth yw eich barn am y gwasanaeth hwn</a> (mae’n cymryd 30 eiliad)"
      }
      ...
      "should render the custom payment complete page for BcPngr" in {
        ...
        document
          .select("#leading-content-wrapper")
          .select("#p1")
          .text() shouldBe "Make a note of your reference number, you may need to provide it to Border Force."
        document
          .select("#leading-content-wrapper")
          .select("#p2")
          .text() shouldBe "If you provided an email address, a copy of this receipt has been sent to you."

        val leadingInfoTableRows: List[Element] = document.select("#leading-info-table").select("tr").asScala.toList
        testTableRows(
          leadingInfoTableRows,
          List(
            "Name",
            "Bob Ross",
            "Date of payment",
        ...
        document
          .select("#arriving-in-uk-wrapper")
          .select("#arriving-in-uk-p1")
          .text() shouldBe "Go to the green ‘nothing to declare’ channel if these are the only items you are declaring. If asked, show your receipt on your mobile phone or tablet to a member of Border Force, or provide your reference number."

        document.select("#amending-declaration-wrapper").select("h2").text() shouldBe "Amending your declaration"
        document
          .select("#amending-declaration-wrapper")
          .select("#amending-declaration-p1")
          .text() shouldBe "You can use this service to add goods to your existing declaration before you arrive in the UK. You will need to enter your reference number."
        document
          .select("#amending-declaration-wrapper")
          .select("#amending-declaration-p2")
          .html() shouldBe "If you need to remove goods from your declaration <a class=\"govuk-link\" href=\"https://www.gov.uk/government/publications/request-a-refund-of-overpaid-vat-or-duty-for-goods-declared-using-the-online-service-for-passengers\">visit GOV.UK to request a refund</a>."
        ...
        document
          .select("#survey-wrapper")
          .select("#survey-link-wrapper")
          .html() shouldBe "<a class=\"govuk-link\" href=\"https://www.tax.service.gov.uk/feedback/passengers\">Tell us what you think of this service</a> (takes 30 seconds)"
      }
      ...
      "should render the custom payment complete page in welsh for BcPngr" in {
        ...
        document
          .select("#leading-content-wrapper")
          .select("#p1")
          .text() shouldBe "Gwnewch nodyn o’ch cyfeirnod, mae’n bosibl y bydd angen i chi ei roi i Lu’r Ffiniau."
        document
          .select("#leading-content-wrapper")
          .select("#p2")
          .text() shouldBe "Os gwnaethoch roi cyfeiriad e-bost, mae copi o’r dderbynneb hon wedi’i hanfon atoch"
        ...
        testTableRows(
          ...
          List(
            ...
            "Cyfeirnod",
            "XAPR9876543210",
            "Swm a dalwyd i CThEM",
            "£12.34",
            "Ffi cerdyn (9.97%), ni ellir ei ad-dalu",
            "£1.23",
            "Cyfanswm a dalwyd",
            "£13.57"
          )
        ...
        testTableRows(
          ...
          List(
            ...
            "",
            "£229.00",
            "Swm a dalwyd yn flaenorol",
            "",
            "£55",
            "Cyfanswm wedi’i dalu nawr",
            "",
            "£1,234"
          )
        )
        ...
        document
          .select("#arriving-in-uk-wrapper")
          .select("#arriving-in-uk-p1")
          .text() shouldBe "Ewch i’r sianel werdd ar gyfer ’dim i’w ddatgan’ os mai dyma’r unig eitemau rydych chi’n eu datgan. Os gofynnir i chi, dangoswch eich derbynneb ar eich ffôn symudol neu lechen i aelod o Lu’r Ffiniau, neu rhowch eich cyfeirnod."

        document.select("#amending-declaration-wrapper").select("h2").text() shouldBe "Diwygio’ch datganiad"
        document
          .select("#amending-declaration-wrapper")
          .select("#amending-declaration-p1")
          .text() shouldBe "Gallwch ddefnyddio’r gwasanaeth hwn i ychwanegu nwyddau at eich datganiad presennol cyn i chi gyrraedd y DU. Bydd angen i chi nodi’ch cyfeirnod."
        document
          .select("#amending-declaration-wrapper")
          .select("#amending-declaration-p2")
          .html() shouldBe "Os oes angen i chi dynnu nwyddau o’ch datganiad, <a class=\"govuk-link\" href=\"https://www.gov.uk/government/publications/request-a-refund-of-overpaid-vat-or-duty-for-goods-declared-using-the-online-service-for-passengers\">ewch GOV.UK i ofyn am ad-daliad</a>."
      ...
      "should have a test for all origins below this one" in {
        TestHelpers.implementedOrigins.size shouldBe 70 withClue "** This dummy test is here to remind you to update the tests below. Bump up the expected number when an origin is added to implemented origins **"
      }
            ...
            "when paying by debit card" - {
              ...
              if (testScenario.hasWelshTest) {
                "render the summary list correctly in welsh" in {
                  testSummaryRows(
                    testScenario.debitCardJourney,
                    fakeGetRequestInWelsh,
                    testScenario.maybeWelshSummaryRowsDebitCard.getOrElse(throw new RuntimeException("test failed, missing welsh when it's expected"))
                  )
                }
              }
            }
            ...
            "when paying by a card that incurs a surcharge" - {
              ...
              if (testScenario.hasWelshTest) {
                "render the summary list correctly in welsh when payment has a surcharge" in {
                  testSummaryRows(
                    testScenario.creditCardJourney,
                    fakeGetRequestInWelsh,
                    testScenario.maybeWelshSummaryRowsCreditCard.getOrElse(throw new RuntimeException("test failed, missing welsh when it's expected"))
                  )
                }
              }
            }
    ...
    "buildAmountsSummaryListRow" - {
      ...
      "should return the relevant amounts for credit card payments in GDS format (i.e. don't show £x.00 when pennies is 0)" in {
        implicit val messages: Messages          = messagesApi.preferred(fakeGetRequest)
        val orderWithPoundsZeroPennies           = Some(
          BarclaysOrder(
        ...
        val journey                              =
          TestJourneys.PfSa.journeyAfterSucceedCreditWebPayment.copy(order = orderWithPoundsZeroPennies, amountInPence = Some(AmountInPence(1234000)))
  ...
  def originToTdAndSummaryListRows: Origin => TestScenarioInfo = {
    ...
    case Origins.PfSa =>
      TestScenarioInfo(
        ...
        maybeWelshSummaryRowsDebitCard = Some(
          List(
            "Treth"   -> "Hunanasesiad",
        ...
        maybeWelshSummaryRowsCreditCard = Some(
          List(
            "Treth"                                   -> "Hunanasesiad",
            "Dyddiad"                                 -> "2 Tachwedd 2027",
    ...
    case Origins.DdVat       =>
      TestScenarioInfo(
        debitCardJourney = TestJourneys.DdVat.journeyAfterSucceedDebitWebPayment,
        creditCardJourney = TestJourneys.DdVat.journeyAfterSucceedCreditWebPayment,
        englishSummaryRowsDebitCard = List(
          "Tax"    -> "VAT",
          "Date"   -> "2 November 2027",
          "Amount" -> "£12.34"
    ...
    case Origins.EconomicCrimeLevy =>
      TestScenarioInfo(
    ...
    case Origins.PfEconomicCrimeLevy =>
      TestScenarioInfo(
    ...
    case Origins.WcSimpleAssessment =>
      TestScenarioInfo(
    ...
    case Origins.DdSdil =>
      TestScenarioInfo(
        debitCardJourney = TestJourneys.DdSdil.journeyAfterSucceedDebitWebPayment,
        creditCardJourney = TestJourneys.DdSdil.journeyAfterSucceedCreditWebPayment,
        englishSummaryRowsDebitCard = List(
          "Tax"    -> "Soft Drinks Industry Levy",
          "Date"   -> "2 November 2027",
          "Amount" -> "£12.34"
