    ...
    "makeSsjJourneyRequest" - {
      ...
      "correctly build a PaymentSurveyJourneyRequest" - {
        ...
        def originToPaymentSurveyJourneyRequestAndLoggedInBool(origin: Origin): (PaymentSurveyJourneyRequest, Boolean) = origin match {
            ...
            PaymentSurveyJourneyRequest(
              ...
              contentOptions = SurveyContentOptions(
                ...
                title = SurveyBannerTitle(
                  englishValue = "Pay your Self Assessment",
                  welshValue = Some("Talu eich Hunanasesiad")
                )
              )
            ) -> false
          case Origins.PfVat                    =>
          ...
          case Origins.PfCt                     =>
            PaymentSurveyJourneyRequest(
              ...
              contentOptions = SurveyContentOptions(
                isWelshSupported = true,
                title = SurveyBannerTitle(
                  englishValue = "Pay your Corporation Tax",
                  welshValue = Some("Talu eich Treth Gorfforaeth")
                )
              )
            ) -> false
          ...
          case Origins.DdVat                    =>
            PaymentSurveyJourneyRequest(
              ...
              contentOptions = SurveyContentOptions(
                isWelshSupported = true,
                title = SurveyBannerTitle(
                  englishValue = "Business tax account",
                  welshValue = Some("Cyfrif treth busnes")
                )
              )
            ) -> true
            ...
            PaymentSurveyJourneyRequest(
              ...
              contentOptions = SurveyContentOptions(
                ...
                title = SurveyBannerTitle(
                  ...
                  welshValue = Some("Taliad llog TWE cyflogwr")
                )
              )
            ) -> true
          ...
          case Origins.Amls                     =>
            PaymentSurveyJourneyRequest(
              ...
              contentOptions = SurveyContentOptions(
                isWelshSupported = true,
                title = SurveyBannerTitle(
                  englishValue = "Pay Money Laundering Regulations fees",
                  welshValue = Some("Talu Ffioedd Rheoliadau Gwyngalchu Arian")
                )
              )
            ) -> true
          case Origins.Ppt                      =>
            PaymentSurveyJourneyRequest(
              ...
              contentOptions = SurveyContentOptions(
                isWelshSupported = true,
                title = SurveyBannerTitle(
                  englishValue = "Pay your Plastic Packaging Tax",
                  welshValue = Some("Talu’ch Treth Deunydd Pacio Plastig")
                )
              )
            ) -> true
          case Origins.PfPpt                    =>
          ...
          case Origins.AlcoholDuty              =>
            PaymentSurveyJourneyRequest(
              ...
              contentOptions = SurveyContentOptions(
                isWelshSupported = true,
                title = SurveyBannerTitle(
                  englishValue = "Pay your Alcohol Duty",
                  welshValue = Some("Talu’ch Toll Alcohol")
                )
              )
            ) -> true
            ...
            PaymentSurveyJourneyRequest(
              ...
              contentOptions = SurveyContentOptions(
                ...
                title = SurveyBannerTitle(
                  ...
                  welshValue = Some("Talwch eich treth")
                )
              )
            ) -> false
          ...
          case Origins.EconomicCrimeLevy        =>
            PaymentSurveyJourneyRequest(
              ...
              contentOptions = SurveyContentOptions(
                isWelshSupported = true,
                title = SurveyBannerTitle(
                  englishValue = "Pay Economic Crime Levy",
                  welshValue = Some("Talu Ardoll Troseddau Economaidd")
                )
              )
            ) -> true
          ...
          case Origins.PfSdlt                   =>
            PaymentSurveyJourneyRequest(
              ...
              contentOptions = SurveyContentOptions(
                isWelshSupported = true,
                title = SurveyBannerTitle(
                  englishValue = "Pay your Stamp Duty Land Tax",
                  welshValue = Some("Talu eich Treth Dir y Tollau Stamp")
                )
              )
            ) -> false
          case Origins.WcSdlt                   =>
          ...
          case Origins.VatC2c                   =>
            PaymentSurveyJourneyRequest(
              ...
              contentOptions = SurveyContentOptions(
                isWelshSupported = true,
                title = SurveyBannerTitle(
                  englishValue = "Pay your import VAT",
                  welshValue = Some("Talu eich TAW fewnforio")
                )
              )
            ) -> true
          ...
          case Origins.WcSimpleAssessment       =>
            PaymentSurveyJourneyRequest(
              ...
              contentOptions = SurveyContentOptions(
                isWelshSupported = true,
                title = SurveyBannerTitle(
                  englishValue = "Pay your Simple Assessment",
                  welshValue = Some("Talu eich Asesiad Syml")
                )
              )
            ) -> false
          ...
          case Origins.PfChildBenefitRepayments =>
            PaymentSurveyJourneyRequest(
              ...
              contentOptions = SurveyContentOptions(
                isWelshSupported = true,
                title = SurveyBannerTitle(
                  englishValue = "Repay Child Benefit overpayments",
                  welshValue = Some("Ad-dalu gordaliadau Budd-dal Plant")
                )
              )
            ) -> false
          case Origins.BtaSdil                  =>
            PaymentSurveyJourneyRequest(
              origin = "BtaSdil",
              returnMsg = "Skip survey, return to business tax account",
              returnHref = "/business-account",
              ...
              contentOptions = SurveyContentOptions(
                isWelshSupported = true,
                title = SurveyBannerTitle(
                  englishValue = "Pay the Soft Drinks Industry Levy",
                  welshValue = Some("Talu Ardoll y Diwydiant Diodydd Ysgafn")
                )
              )
            ) -> true
          case Origins.DdSdil                   =>
          ...
          case Origins.NiEuVatOss               =>
            PaymentSurveyJourneyRequest(
              ...
              contentOptions = SurveyContentOptions(
                ...
                title = SurveyBannerTitle(
                  englishValue = "Pay your One Stop Shop VAT Return",
                  welshValue = None
                )
              )
            ) -> false
          case Origins.PfNiEuVatOss             =>
            PaymentSurveyJourneyRequest(
              origin = "PfNiEuVatOss",
              returnMsg = "Skip survey",
              returnHref = "https://www.gov.uk/government/organisations/hm-revenue-customs",
          ...
          case Origins.NiEuVatIoss              =>
            PaymentSurveyJourneyRequest(
              ...
              contentOptions = SurveyContentOptions(
                isWelshSupported = false,
                title = SurveyBannerTitle(
                  englishValue = "Pay your Import One Stop Shop VAT Return",
                  welshValue = None
                )
              )
            ) -> false
          case Origins.PfNiEuVatIoss            =>
            PaymentSurveyJourneyRequest(
          ...
          case Origins.PfP800                   =>
            PaymentSurveyJourneyRequest(
              ...
              contentOptions = SurveyContentOptions(
                isWelshSupported = true,
                title = SurveyBannerTitle(
                  englishValue = "Check how much Income Tax you paid",
                  welshValue = Some("Gwirio faint o dreth incwm a daloch")
                )
              )
            ) -> true
          case Origins.PtaP800                  =>
            PaymentSurveyJourneyRequest(
              origin = "PtaP800",
              returnMsg = "Skip survey",
              returnHref = "https://www.gov.uk/government/organisations/hm-revenue-customs",
          ...
          case Origins.PfSimpleAssessment       =>
            PaymentSurveyJourneyRequest(
          ...
          case Origins.PtaSimpleAssessment      =>
            PaymentSurveyJourneyRequest(
          ...
          case Origins.PfJobRetentionScheme =>
            PaymentSurveyJourneyRequest(
          ...
          case Origins.JrsJobRetentionScheme =>
            PaymentSurveyJourneyRequest(
          ...
          case Origins.PfCds =>
            PaymentSurveyJourneyRequest(
              ...
              contentOptions = SurveyContentOptions(
                isWelshSupported = false,
                title = SurveyBannerTitle(
                  englishValue = "Customs Declaration Service",
                  welshValue = None
                )
              )
            ) -> false
          ...
          case Origins.AppSimpleAssessment =>
            PaymentSurveyJourneyRequest(
          ...
          case Origins.PfTpes =>
            PaymentSurveyJourneyRequest(
              ...
              contentOptions = SurveyContentOptions(
                isWelshSupported = true,
                title = SurveyBannerTitle(
                  englishValue = "Pay taxes, penalties or enquiry settlements",
                  welshValue = Some("Talu trethi, cosbau neu setliadau ymholiadauhmmm")
                )
              )
            ) -> false
          ...
          case Origins.PfMgd =>
            PaymentSurveyJourneyRequest(
              ...
              contentOptions = SurveyContentOptions(
                isWelshSupported = true,
                title = SurveyBannerTitle(
                  englishValue = "Pay Machine Games Duty",
                  welshValue = Some("Talu’r Doll Peiriannau Hapchwarae")
                )
              )
            ) -> false

          case Origins.PfGbPbRgDuty =>
            PaymentSurveyJourneyRequest(
              origin = "PfGbPbRgDuty",
              returnMsg = "Skip survey",
              returnHref = "https://www.gov.uk/government/organisations/hm-revenue-customs",
              ...
              contentOptions = SurveyContentOptions(
                isWelshSupported = true,
                title = SurveyBannerTitle(
                  englishValue = "Pay General Betting, Pool Betting or Remote Gaming Duty",
                  welshValue = Some("Talu Toll Betio Cyffredinol, Toll Cronfa Fetio neu Doll Hapchwarae o Bell")
                )
              )
            ) -> false

          case Origins.PfTrust =>
            PaymentSurveyJourneyRequest(
              origin = "PfTrust",
              returnMsg = "Skip survey",
              returnHref = "https://www.gov.uk/government/organisations/hm-revenue-customs",
              ...
              contentOptions = SurveyContentOptions(
                isWelshSupported = true,
                title = SurveyBannerTitle(
                  englishValue = "Pay a Trust Registration Service penalty charge",
                  welshValue = Some("Talu tâl cosb y Gwasanaeth Cofrestru Ymddiriedolaethau")
                )
              )
            ) -> false

          case Origins.PfPsAdmin =>
            PaymentSurveyJourneyRequest(
              origin = "PfPsAdmin",
              returnMsg = "Skip survey",
              returnHref = "https://www.gov.uk/government/organisations/hm-revenue-customs",
              ...
              contentOptions = SurveyContentOptions(
                isWelshSupported = true,
                title = SurveyBannerTitle(
                  englishValue = "Pay your pension scheme tax charges",
                  welshValue = Some("Talu’ch taliadau treth ar gynllun pensiwn")
                )
              )
            ) -> false

          case Origins.PfOther =>
            PaymentSurveyJourneyRequest(
              origin = "PfOther",
              returnMsg = "Skip survey",
              returnHref = "https://www.gov.uk/government/organisations/hm-revenue-customs",
          ...
          case Origins.WcChildBenefitRepayments =>
            PaymentSurveyJourneyRequest(
          ...
          case Origins.PfStampTaxesOnShares     =>
            PaymentSurveyJourneyRequest(
          ...
          case Origins.BtaVapingProductsDuty    =>
            PaymentSurveyJourneyRequest(
              ...
              contentOptions = SurveyContentOptions(
                isWelshSupported = false,
                title = SurveyBannerTitle(
                  englishValue = "service-name.BtaVapingProductsDuty",
                  welshValue = None
                )
              )
            ) -> true
          case Origins.VpdVapingProductsDuty    =>
            PaymentSurveyJourneyRequest(
              ...
              contentOptions = SurveyContentOptions(
                isWelshSupported = false,
                title = SurveyBannerTitle(
                  englishValue = "service-name.VpdVapingProductsDuty",
                  welshValue = None
                )
              )
            ) -> true
