...
class EmailServiceSpec extends ItSpec with TableDrivenPropertyChecks {
  ...
  "buildEmailParameters should return EmailParameters" - {
    ...
    val scenarios: TableFor6[JourneyStatuses[_ >: JsdBounds <: JourneySpecificData], String, String, Option[String], Option[String], String] = Table(
      ...
      (WcClass2Ni, "Class 2 National Insurance", "ending with 45678", None, None, "en"),
      (WcClass2Ni, "Class 2 National Insurance", "ending with 45678", commission, Some("13.57"), "en"),
      (WcClass2Ni, "Yswiriant Gwladol Dosbarth 2", "yn gorffen gyda 45678", None, None, "cy"),
      (WcClass2Ni, "Yswiriant Gwladol Dosbarth 2", "yn gorffen gyda 45678", commission, Some("13.57"), "cy")
    )
