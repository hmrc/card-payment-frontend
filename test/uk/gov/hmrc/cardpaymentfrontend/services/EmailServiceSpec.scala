...
class EmailServiceSpec extends ItSpec with TableDrivenPropertyChecks {
  ...
  "buildEmailParameters should return EmailParameters" - {
    ...
    val scenarios: TableFor6[JourneyStatuses[_ >: JsdBounds <: JourneySpecificData], String, String, Option[String], Some[String], String] = Table(
      ...
      (JrsJobRetentionScheme, "Coronavirus Job Retention Scheme", "ending with 89012", None, Some("12.34"), "en"),
      (JrsJobRetentionScheme, "Coronavirus Job Retention Scheme", "ending with 89012", commission, Some("13.57"), "en"),
      (JrsJobRetentionScheme, "Cynllun Cadw Swyddi yn sgil Coronafeirws", "yn gorffen gyda 89012", None, Some("12.34"), "cy"),
      (JrsJobRetentionScheme, "Cynllun Cadw Swyddi yn sgil Coronafeirws", "yn gorffen gyda 89012", commission, Some("13.57"), "cy"),

      (PfJobRetentionScheme, "Coronavirus Job Retention Scheme", "ending with 89012", None, Some("12.34"), "en"),
      (PfJobRetentionScheme, "Coronavirus Job Retention Scheme", "ending with 89012", commission, Some("13.57"), "en"),
      (PfJobRetentionScheme, "Cynllun Cadw Swyddi yn sgil Coronafeirws", "yn gorffen gyda 89012", None, Some("12.34"), "cy"),
      (PfJobRetentionScheme, "Cynllun Cadw Swyddi yn sgil Coronafeirws", "yn gorffen gyda 89012", commission, Some("13.57"), "cy")
    )
