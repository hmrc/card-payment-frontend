...
object PassengersStub {

  private val notificationPath: String = "/bc-passengers-declarations/update-payment"

  def stubNotification2xx(): StubMapping =
    stubFor(
  ...
  def verifyNotificationSent(notificationJson: JsValue): Unit =
    verify(
      1,
