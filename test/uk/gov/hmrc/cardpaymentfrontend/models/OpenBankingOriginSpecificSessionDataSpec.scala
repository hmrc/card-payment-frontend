...
class OpenBankingOriginSpecificSessionDataSpec extends UnitSpec {
  ...
  "Each extended origin should have a way to generate OriginSpecificSessionData for open banking" - {
    ...
    "AlcoholDuty" in {
      ...
      testOsd(
        osd,
        AlcoholDutySessionData(AlcoholDutyReference("XMADP0123456789"), Some(AlcoholDutyChargeReference("XE1234567890123")), None),
        "XE1234567890123",
        "XMADP0123456789"
      )
      roundTripJsonTest(osd, testJson)
    ...
    "PfEpayeNi" in {
      ...
      testOsd(
        osd,
        PfEpayeNiSessionData(AccountsOfficeReference("123PH45678900"), QuarterlyEpayeTaxPeriod(AprilJuly, TaxYear(2025)), None),
        "123PH456789002503",
        "123PH45678900"
      )
      roundTripJsonTest(osd, testJson)
    ...
    "PfEpayeP11d" in {
      ...
      testOsd(
        osd,
        PfEpayeP11dSessionData(AccountsOfficeReference("123PH45678900"), YearlyEpayeTaxPeriod(TaxYear(2025)), None),
        "123PH456789002513",
        "123PH45678900"
      )
      roundTripJsonTest(osd, testJson)
    ...
    "BtaEpayeBill" in {
      ...
      testOsd(
        osd,
        BtaEpayeBillSessionData(AccountsOfficeReference("123PH45678900"), MonthlyEpayeTaxPeriod(TaxMonth.MayJune, TaxYear(2027)), None),
        "123PH456789002702",
        "123PH45678900"
      )
      roundTripJsonTest(osd, testJson)
    ...
    "BtaEpayeGeneral" in {
      ...
      testOsd(
        osd,
        BtaEpayeGeneralSessionData(AccountsOfficeReference("123PH45678900"), MonthlyEpayeTaxPeriod(TaxMonth.MayJune, TaxYear(2027)), None),
        "123PH456789002702",
        "123PH45678900"
      )
      roundTripJsonTest(osd, testJson)
    ...
    "BtaClass1aNi" in {
      ...
      testOsd(
        osd,
        BtaClass1aNiSessionData(AccountsOfficeReference("123PH45678900"), YearlyEpayeTaxPeriod(TaxYear(2027)), None),
        "123PH456789002713",
        "123PH45678900"
      )
      roundTripJsonTest(osd, testJson)
    ...
    "PfEconomicCrimeLevy" in {
      ...
      val osd      =
        ExtendedPfEconomicCrimeLevy.openBankingOriginSpecificSessionData(TestJourneys.PfEconomicCrimeLevy.journeyBeforeBeginWebPayment.journeySpecificData)
    ...
    "WcSimpleAssessment" in {
      ...
      val osd      =
        ExtendedWcSimpleAssessment.openBankingOriginSpecificSessionData(TestJourneys.WcSimpleAssessment.journeyBeforeBeginWebPayment.journeySpecificData)
    ...
    "PfChildBenefitRepayments" in {
      ...
      val osd      = ExtendedPfChildBenefitRepayments.openBankingOriginSpecificSessionData(
        TestJourneys.PfChildBenefitRepayments.journeyBeforeBeginWebPayment.journeySpecificData
      )
    ...
    "WcChildBenefitRepayments" in {
      ...
      val osd      = ExtendedWcChildBenefitRepayments.openBankingOriginSpecificSessionData(
        TestJourneys.WcChildBenefitRepayments.journeyBeforeBeginWebPayment.journeySpecificData
      )
    ...
    "PtaP800" - {
      "when feature flag for enabling open banking is true" - {
        ...
        "with charge ref" in {
          ...
          val osd      = new ExtendedPtaP800(appConfig).openBankingOriginSpecificSessionData(
            TestJourneys.PtaP800.journeyWithP800ChargeRefBeforeBeginWebPayment.journeySpecificData
          )
          testOsd(
            osd,
            PtaP800SessionData(P800Ref("MA000003AP8002027"), Some(P800ChargeRef("BC007010065114")), Some(TaxYear(2027)), None),
            "BC007010065114",
            "MA000003AP8002027"
          )
          roundTripJsonTest(osd, testJson)
    ...
    "PfSimpleAssessment" in {
      ...
      val osd      =
        ExtendedPfSimpleAssessment.openBankingOriginSpecificSessionData(TestJourneys.PfSimpleAssessment.journeyBeforeBeginWebPayment.journeySpecificData)
    ...
    "PtaSimpleAssessment" in {
      ...
      val osd      =
        ExtendedPtaSimpleAssessment.openBankingOriginSpecificSessionData(TestJourneys.PtaSimpleAssessment.journeyBeforeBeginWebPayment.journeySpecificData)
    ...
    "PfJobRetentionScheme" in {
      ...
      val osd      =
        ExtendedPfJobRetentionScheme.openBankingOriginSpecificSessionData(TestJourneys.PfJobRetentionScheme.journeyBeforeBeginWebPayment.journeySpecificData)
    ...
    "JrsJobRetentionScheme" in {
      ...
      val osd      =
        ExtendedJrsJobRetentionScheme.openBankingOriginSpecificSessionData(TestJourneys.JrsJobRetentionScheme.journeyBeforeBeginWebPayment.journeySpecificData)
    ...
    "AppSimpleAssessment" in {
      ...
      val osd      =
        ExtendedAppSimpleAssessment.openBankingOriginSpecificSessionData(TestJourneys.AppSimpleAssessment.journeyBeforeBeginWebPayment.journeySpecificData)
    ...
    "WcSdlt" in {
      val testJson = Json.parse("""{"utrn":"123456789MA","origin":"WcSdlt"}""")
      val osd      = ExtendedWcSdlt.openBankingOriginSpecificSessionData(TestJourneys.WcSdlt.journeyBeforeBeginWebPayment.journeySpecificData)
      testOsd(osd, WcSdltSessionData(Utrn("123456789MA"), None), "123456789MA", "123456789MA")
      roundTripJsonTest(osd, testJson)
    }

    "DdVat" in {
      val testJson = Json.parse("""{"vrn":"999964805","origin":"DdVat"}""")
      val osd      = ExtendedDdVat.openBankingOriginSpecificSessionData(TestJourneys.DdVat.journeyBeforeBeginWebPayment.journeySpecificData)
      testOsd(osd, DdVatSessionData(Vrn("999964805"), None), "999964805", "999964805")
      roundTripJsonTest(osd, testJson)
    }
    ...
    "PfStampTaxesOnShares" in {
      val testJson = Json.parse(
        // language=JSON
        """{
          |  "securitiesTransferChargeReference": "XE123456789012",
          |  "origin": "PfStampTaxesOnShares"
          |}""".stripMargin
      )
      val osd      =
        ExtendedPfStampTaxesOnShares.openBankingOriginSpecificSessionData(TestJourneys.PfStampTaxesOnShares.journeyBeforeBeginWebPayment.journeySpecificData)
      testOsd(
        osd,
        PfStampTaxesOnSharesSessionData(
