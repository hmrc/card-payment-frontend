...
pfsa.email.supply-link.text.new  = TBS
...
pfvat.email.supply-link.text.new  = TBS
...
ptasa.email.supply-link.text.new  = TBS
...
payment-complete.tax-name.PfMgd =
